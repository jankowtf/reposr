...
#' 
#' \itemize{
#'    \item{\code{\link[reposr]{PackageRepository}}: }{
#'    
...
#' 
#'  \itemize{
#'    \item{\code{\link[reposr]{ensure}}: }{
#'    
#'      Creates/ensure a local package repository with
#'      \code{repo$ensure()}
#'    }
#'    \item{\code{\link[reposr]{exists}}: }{
#'    
#'      Verify existence with
#'      \code{repo$exists()}
#'    }
#'    \item{\code{\link[reposr]{register}}: }{
#'    
#'      Register your repository in the R options with 
#'      \code{repo$register()}
#'    }
#'    \item{\code{\link[reposr]{browse}}: }{
#'    
#'      Browse content with
...
#'    }
#'    \item{\code{\link[reposr]{refresh}}: }{
#'    
#'      Refresh with
#'      \code{repo$refresh()}
#'    }
#'    \item{\code{\link[reposr]{clean}}: }{
#'    
...
#'    }
#'    \item{\code{\link[reposr]{reset}}: }{
#'    
#'      Reset entire repository with
#'      \code{repo$reset()}
#'    }
#'    \item{\code{\link[reposr]{delete}}: }{
#'    
...
#' @docType package
#' @name reposr
#' @seealso \url{https://github.com/rappster/reposr}
NULL
